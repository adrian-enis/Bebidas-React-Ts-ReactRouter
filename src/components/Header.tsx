/**
 * @file Componente del encabezado de la aplicación.
 * @module Header
 */
...
/**
 * Componente que renderiza el encabezado de la aplicación.
 * @function Header
 * @returns {JSX.Element}
 */
function Header() {
          ...
          <form className="md:w-1/2 2xl:w-1/3 bg-orange-400 my-32 p-10 rounded-lg shadow space-y-6">
            ...
            <div className="space-y-4">
              ...
              <select
                ...
                {
                  categories.drinks.map((state) => (
                    <option key={state.strGlass} value={state.strGlass} id={state.strGlass}>
                      {state.strGlass}
                    </option>
                  ))
                }
